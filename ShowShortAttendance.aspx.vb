...
Imports System.Data
Public Class ShowShortAttendance
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            If Not IsPostBack Then
                ...
                con.Open()
                temp = Convert.ToString(Session("Courseid"))

                Dim p As String = "74"
                cmd = New SqlCommand("select * from [" & temp & "T]  WHERE AttendancePercentage BETWEEN 0 AND 74", con)
