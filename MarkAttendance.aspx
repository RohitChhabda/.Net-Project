<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Mpage.Master" CodeFile="MarkAttendance.aspx.vb" Inherits="MarkAttendance" %>
       ...
       <table class="formm">
           <tr>
               ...
               <td class="auto-style10">
                   ...
                   <asp:TextBox ID="TextBox2" placeholder="Eg:dd/mm/yy" runat="server" Height="31px" Width="239px" required="true"></asp:TextBox>
